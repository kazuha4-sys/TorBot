...
from torbot.modules.linktree import parse_hostname, pasre_linktree, parse_emails, parse_phone_numbers

def test_parse_hostname() -> None:
    https_test_url = "https://www.example.com"
    assert parse_hostname(https_test_url) == "www.example.com"

    http_test_url = "http://www.example.com"
    assert parse_hostname(http_test_url) == "www.example.com"

def test_pasre_links() -> None:
